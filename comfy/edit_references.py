...
# 3090 FORK: paths were hardcoded to B:\amd-hackathon-bill-analyzer\... which
# pointed at the AMD-baseline copy of identical assets. Now derived from this
# script's location so the fork uses its own eval/ and comfy/workflows/.
_REPO_ROOT = Path(__file__).resolve().parent.parent
DEFAULT_RELAY_FILE = _REPO_ROOT / "eval" / "prompt-relay-bbb-ch01-day6.json"
DEFAULT_WORKFLOW = _REPO_ROOT / "comfy" / "workflows" / "qwen-image-edit-api.json"
